...
router.beforeEach(async (to) => {
  ...
  if (to.meta.guestOnly && auth.isAuthenticated) return isPlatformHost() ? "/platform" : "/school";
  if (to.meta.auth && !auth.isAuthenticated) return `/login?redirect=${encodeURIComponent(to.fullPath)}`;
