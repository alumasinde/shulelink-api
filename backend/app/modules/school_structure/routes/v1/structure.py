...
def _route(prefix,schema,response,table):
    pass
...
async def update_setting(setting_key:str,payload:SettingUpdate,tenant_id=Depends(manage_tenant),principal=Depends(__import__('app.core.dependencies',fromlist=['get_current_principal']).get_current_principal)):
