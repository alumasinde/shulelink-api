...
class AttendanceSessionCreate(BaseModel):
    ...
    session_type: AttendanceSessionType = "daily"
    session_date: date
...
class AttendanceSessionResponse(BaseModel):
    ...
    status: str
    attendance_policy_id: UUID | None
    notes: str | None
    roster_count: int = 0
    marked_count: int = 0
...
class RosterStudent(BaseModel):
    ...
    stream_id: UUID | None
    enrollment_id: UUID
    residency_type: str = "day_scholar"
    status_code: str = "not_marked"
    status_name: str = "Not Marked"
