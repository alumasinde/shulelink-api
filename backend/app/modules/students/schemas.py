...
class StudentCreate(BaseModel):
    # Admission number is generated by the server from the school's configuration.
...
class AdmissionNumberSettings(BaseModel):
    prefix: str = Field(default="ADM", max_length=30)
    separator: str = Field(default="-", max_length=5)
    include_year: bool = True
    year_format: str = Field(default="YYYY", pattern="^(YYYY|YY)$")
    padding: int = Field(default=4, ge=1, le=10)
    start: int = Field(default=1, ge=1, le=1_000_000_000)
