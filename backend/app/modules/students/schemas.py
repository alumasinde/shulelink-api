...
class StudentCreate(BaseModel):
    admission_number:str|None=Field(default=None,max_length=80); first_name:str=Field(min_length=1,max_length=100); middle_name:str|None=Field(default=None,max_length=100); last_name:str=Field(min_length=1,max_length=100); date_of_birth:date|None=None; gender:str=Field(default="unspecified",pattern="^(male|female|other|unspecified)$"); nationality:str|None=Field(default=None,max_length=80); birth_certificate_number:str|None=Field(default=None,max_length=100); admission_date:date|None=None; previous_school:str|None=Field(default=None,max_length=190); status:str=Field(default="active",pattern="^(active|inactive|graduated|transferred|withdrawn)$"); medical_notes:str|None=None; emergency_notes:str|None=None
...
class StudentUpdate(BaseModel):
    first_name:str|None=Field(default=None,min_length=1,max_length=100); middle_name:str|None=Field(default=None,max_length=100); last_name:str|None=Field(default=None,min_length=1,max_length=100); date_of_birth:date|None=None; gender:str|None=Field(default=None,pattern="^(male|female|other|unspecified)$"); nationality:str|None=Field(default=None,max_length=80); birth_certificate_number:str|None=Field(default=None,max_length=100); admission_date:date|None=None; previous_school:str|None=Field(default=None,max_length=190); status:str|None=Field(default=None,pattern="^(active|inactive|graduated|transferred|withdrawn)$"); medical_notes:str|None=None; emergency_notes:str|None=None
...
class GuardianCreate(BaseModel):
    first_name:str=Field(min_length=1,max_length=100); last_name:str=Field(min_length=1,max_length=100); phone:str|None=Field(default=None,max_length=40); alternative_phone:str|None=Field(default=None,max_length=40); email:str|None=None; address:str|None=Field(default=None,max_length=255); occupation:str|None=Field(default=None,max_length=150); employer:str|None=Field(default=None,max_length=190); preferred_contact_method:str=Field(default="phone",pattern="^(phone|sms|email|whatsapp|any)$"); status:str=Field(default="active",pattern="^(active|inactive)$")
    @field_validator("email")
    @classmethod
    def email_valid(cls,value):return validate_email(value)
class GuardianUpdate(BaseModel):
    first_name:str|None=Field(default=None,min_length=1,max_length=100); last_name:str|None=Field(default=None,min_length=1,max_length=100); phone:str|None=Field(default=None,max_length=40); alternative_phone:str|None=Field(default=None,max_length=40); email:str|None=None; address:str|None=Field(default=None,max_length=255); occupation:str|None=Field(default=None,max_length=150); employer:str|None=Field(default=None,max_length=190); preferred_contact_method:str|None=Field(default=None,pattern="^(phone|sms|email|whatsapp|any)$"); status:str|None=Field(default=None,pattern="^(active|inactive)$")
    @field_validator("email")
    @classmethod
    def email_valid(cls,value):return validate_email(value)
...
class EnrollmentCreate(BaseModel): academic_year_id:UUID; class_level_id:UUID; stream_id:UUID|None=None; enrollment_date:date; exit_date:date|None=None; status:str=Field(default="active",pattern="^(active|completed|withdrawn)$"); notes:str|None=None
class EnrollmentUpdate(BaseModel): enrollment_date:date|None=None; exit_date:date|None=None; status:str|None=Field(default=None,pattern="^(active|completed|withdrawn)$"); notes:str|None=None
