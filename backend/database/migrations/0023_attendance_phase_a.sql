...
-- Tenant-scoped attendance domain. Capture/rules/notifications follow in later phases.
...
VALUES
    ...
    (UUID(), 'on_leave', 'On Leave', 'Student has approved leave covering the session.', 'leave', 1, 1, 50),
