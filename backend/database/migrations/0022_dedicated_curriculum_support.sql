...
-- The provisioner skips 0021 there and applies this portable tenant schema instead.

CREATE TABLE IF NOT EXISTS tenant_curriculum_profiles (
    id CHAR(36) NOT NULL, tenant_id CHAR(36) NOT NULL, platform_template_id CHAR(36) NOT NULL,
    template_code VARCHAR(100) NOT NULL, template_version INT UNSIGNED NOT NULL,
    status VARCHAR(30) NOT NULL DEFAULT 'active', selected_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    selected_by CHAR(36) NULL, allow_local_customization TINYINT(1) NOT NULL DEFAULT 1,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id), UNIQUE KEY uq_tenant_curriculum_profile (tenant_id)
...
CREATE TABLE IF NOT EXISTS teacher_subjects (
    id CHAR(36) NOT NULL, tenant_id CHAR(36) NOT NULL, teacher_id CHAR(36) NOT NULL, subject_id CHAR(36) NOT NULL,
    created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id),
    UNIQUE KEY uq_teacher_subject (tenant_id,teacher_id,subject_id), KEY ix_teacher_subjects_teacher (tenant_id,teacher_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
